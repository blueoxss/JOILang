...
STRICT_OUT_NAME="${STRICT_OUT_NAME:-model_suite_v13_strict_280}"
STRICT_DIR="gpt_mg/version0_15_update20260413/results/${STRICT_OUT_NAME}"
...
cd "$BASE_DIR/utils/evaluation_cloud"

EVAL_LIMIT="$EVAL_LIMIT" python main_evaluator.py \
  lang gpt joi "$PROMPT_VERSION" \
  --out-dir "$CLOUD_OUT_REL"
