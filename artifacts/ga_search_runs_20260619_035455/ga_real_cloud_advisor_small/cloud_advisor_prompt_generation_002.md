...
feedback_packet:
{
  "advisor_batch_id": "advisor_batch_g002_3360bc3b",
  "generation": 2,
  ...
  "category_diagnostics": [
    {
      ...
      "dominant_failure_type": "invalid_json",
      "likely_prompt_issue": "Failures are concentrated in JSON/output-schema validity; the prompt likely needs stronger JSON-only and required-key grounding.",
      "recommended_mutation_family": "accuracy_repair",
      "suggested_target_block": "03",
      "suggested_target_block_family": "Output_Schema",
      ...
      "representative_failures": [
        {
          ...
          "category": 1,
          "group": "basic",
          "command": "Switch the dishwasher to dry mode.",
          ...
          "receiver_mismatch": false,
          "service_mismatch": false,
          "enum_mismatch": false,
          "temporal_mismatch": false,
          "dataflow_mismatch": false,
          "extraneous_action": false,
          "missing_action": false,
          "diagnostic_summary": "Failures are concentrated in JSON/output-schema validity; the prompt likely needs stronger JSON-only and required-key grounding.",
          "suggested_prompt_block": "03",
          "suggested_mutation_type": "strengthen_json_only_rule",
      ...
      "representative_failures": [
        {
          ...
          "category": 2,
          "group": "basic",
          "command": "Set the living room light to yellow.",
          "expected": "{\"name\": \"\", \n\"cron\": \"\", \n\"period\": 0, \n\"script\": \"(#LivingRoom #Light).colorcontrol_setcolor(\\\"255,255,0\\\")\"}",
          "candidate": "",
          "failure_reasons": [
            "invalid_json"
          ],
  ...
  "genome_diagnostics": {
    "top_genomes": [
      {
        "rank": 1,
        "genome_id": "gen-109fb9b5-4062-479c-fb5b-7bad30198596",
        "det_pass_rate": 0.0,
        "avg_det_score": 0.0,
      ...
      {
        "rank": 2,
        "genome_id": "gen-2e1069de-7225-be6c-3bf6-baf915e48f91",
        "det_pass_rate": 0.0,
        "avg_det_score": 0.0,
        "avg_prompt_tokens": 0.0,
        "blocks": [
    ...
    "bottom_genomes": [
      {
        "rank": 1,
        "genome_id": "gen-3b1ea01c-673b-58d1-52da-f6d4d9796538",
        "det_pass_rate": 0.0,
        "avg_det_score": 0.0,
        "avg_prompt_tokens": 0.0,
        "blocks": [
  ...
  "current_prompt_artifact": {
    ...
    "micro_rules_by_block": {
      ...
      "03": [
        "Enforce strict JSON-only output with all required keys: name, cron, period, script; disallow any non-JSON text or prose."
      ]
    },
    "prompt_token_count": 0.0,
    "block_signature": "01,02,05,06",
    "prompt_hash": "0aa5e3dc35c3f5b9"
  },
  "prompt_token_breakdown": {
    "generation": 2,
    "model_key": "qwen25_coder_14b",
    "total_prompt_token_estimate": 15132,
    "block_token_total_estimate": 15083,
    "genome_params_token_estimate": 49,
    "measurement_method": "char_div_4_estimate",
    "largest_token_component": "02",
    "largest_token_component_tokens": 6864
  },
  ...
  "advisor_request": {
    ...
    "compression_policy": {
      ...
      "compression_phase": "ACCURACY_SEARCH",
