...
Input package:
{
  "meta": {
    ...
    "created_at": "2026-06-26T15:30:07",
  ...
  "selected_block_candidates": [
    {
      ...
      "summary": "Temporal scheduling, cron, period, delay, loop, numeric/time grounding, and temporal dataflow.",
      "current_rule_summary": "Temporal scheduling, cron, period, delay, loop, numeric/time grounding, and temporal dataflow.",
      "allowed_operations": [
        "append_micro_rule",
        "replace_micro_rule",
        "compress_block_rule"
    ...
    },
    {
      ...
      "summary": "Caution rules, anti-hallucination, row independence, skeleton, minimality, and final self-check.",
      "current_rule_summary": "Caution rules, anti-hallucination, row independence, skeleton, minimality, and final self-check.",
      "allowed_operations": [
        "append_micro_rule",
        "replace_micro_rule",
        "compress_block_rule"
    ...
    },
    {
      ...
      "summary": "Canonical device/service selection, receiver tag preservation, service descriptor and enum grounding.",
      "current_rule_summary": "Canonical device/service selection, receiver tag preservation, service descriptor and enum grounding.",
      "allowed_operations": [
        "append_micro_rule",
        "replace_micro_rule",
        "compress_block_rule"
    ...
    },
    {
      ...
      "summary": "Retry and repair instruction for failed or incomplete JOILang generation.",
      "current_rule_summary": "Retry and repair instruction for failed or incomplete JOILang generation.",
      "allowed_operations": [
        "append_micro_rule",
        "replace_micro_rule",
        "compress_block_rule"
    ...
    },
    {
      ...
      "summary": "Final response format, JSON-only output, required keys, and response skeleton.",
      "current_rule_summary": "Final response format, JSON-only output, required keys, and response skeleton.",
      "allowed_operations": [
        "append_micro_rule",
        "replace_micro_rule",
        "compress_block_rule"
    ...
    },
    {
      ...
      "summary": "JOILang grammar, syntax rules, allowed constructs, and code-level constraints.",
      "current_rule_summary": "JOILang grammar, syntax rules, allowed constructs, and code-level constraints.",
      "allowed_operations": [
        "append_micro_rule",
        "replace_micro_rule",
        "compress_block_rule"
